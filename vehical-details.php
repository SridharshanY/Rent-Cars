  ...
  if ($query->rowCount() > 0) {
    ...
    <h5>
        <?php if ($result->RegistrationDoc == "") {
            ...
            $reg_absolute_path = "admin/img/vehicledocs/" . htmlentities($result->RegistrationDoc);
            ?>
            <a href="<?php echo $reg_absolute_path; ?>" target="_blank">View</a>
        <?php } ?>
    </h5>
    <p>Registration</p>
</li>
<li> <i class="fa fa-shield" aria-hidden="true"></i>
    <h5>
        <?php if ($result->InsuranceDoc == "") {
            ...
            $ins_absolute_path = "admin/img/vehicledocs/" . htmlentities($result->InsuranceDoc);
            ?>
            <a href="<?php echo $ins_absolute_path; ?>" target="_blank">View</a>
        <?php } ?>
    </h5>
    <p>Insurance</p>
</li>                </ul>
                ...
                <div class="product-listing-m gray-bg">
                  ...
                  <div class="product-listing-content">
                    ...
                    <ul class="features_list">
                      ...
                      <li><i class="fa fa-file-text-o" aria-hidden="true"></i>
                        <?php if ($result->RegistrationDoc == "") {
                          echo htmlentities("Registration not available");
                        } else { ?>
                          <a href="img/vehicledocs/<?php echo htmlentities($result->RegistrationDoc); ?>"
                            target="_blank">Registration Doc</a>
                        <?php } ?>
                      </li>
                      <li><i class="fa fa-shield" aria-hidden="true"></i>
                        <?php if ($result->InsuranceDoc == "") {
                          ...
                          <a href="img/vehicledocs/<?php echo htmlentities($result->InsuranceDoc); ?>"
                            target="_blank">Insurance Doc</a>
                        <?php } ?>
                      </li>
                    </ul>
                  </div>
