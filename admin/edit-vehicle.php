...
// New document fields
$registrationdoc = isset($_FILES["registrationdoc"]["name"]) && !empty($_FILES["registrationdoc"]["name"]) ? $_FILES["registrationdoc"]["name"] : null;
$insurancedoc = isset($_FILES["insurancedoc"]["name"]) && !empty($_FILES["insurancedoc"]["name"]) ? $_FILES["insurancedoc"]["name"] : null;
...
if($registrationdoc) {
    move_uploaded_file($_FILES["registrationdoc"]["tmp_name"], "img/vehicledocs/".$_FILES["registrationdoc"]["name"]);
}
if($insurancedoc) {
    move_uploaded_file($_FILES["insurancedoc"]["tmp_name"], "img/vehicledocs/".$_FILES["insurancedoc"]["name"]);
}

// Update query with conditional document fields
...
if($registrationdoc) $sql .= "RegistrationDoc=:registrationdoc,";
if($insurancedoc) $sql .= "InsuranceDoc=:insurancedoc,";
$sql .= "AirConditioner=:airconditioner,
...
if($registrationdoc) $query->bindParam(':registrationdoc',$registrationdoc,PDO::PARAM_STR);
if($insurancedoc) $query->bindParam(':insurancedoc',$insurancedoc,PDO::PARAM_STR);
...
<?php if($result->RegistrationDoc=="") {
    echo htmlentities("File not available");
} else {?>
<a href="img/vehicledocs/<?php echo htmlentities($result->RegistrationDoc);?>" target="_blank">View Current Document</a>
<?php } ?>
<input type="file" name="registrationdoc" accept=".pdf,.doc,.docx">
</div>
<div class="col-sm-4">
Insurance Document
<?php if($result->InsuranceDoc=="") {
    echo htmlentities("File not available");
} else {?>
<a href="img/vehicledocs/<?php echo htmlentities($result->InsuranceDoc);?>" target="_blank">View Current Document</a>
<?php } ?>
<input type="file" name="insurancedoc" accept=".pdf,.doc,.docx">
</div>
</div>
...
<div class="col-sm-3">
<div class="checkbox checkbox-inline">
<input type="checkbox" id="inlineCheckbox5" name="powersteering" checked value="1">
<label for="inlineCheckbox5"> Power Steering </label>
</div>
<?php } else {?>
<div class="col-sm-3">
<div class="checkbox checkbox-inline">
<input type="checkbox" id="inlineCheckbox5" name="powersteering" value="1">
<label for="inlineCheckbox5"> Power Steering </label>
</div>
<?php } ?>
</div>
...
<div class="checkbox checkbox-inline">
<input type="checkbox" id="inlineCheckbox6" name="driverairbag" checked value="1">
<label for="inlineCheckbox6">Driver Airbag</label>
</div>
<?php } else { ?>
<div class="checkbox checkbox-inline">
<input type="checkbox" id="inlineCheckbox6" name="driverairbag" value="1">
<label for="inlineCheckbox6">Driver Airbag</label>
<?php } ?>
</div>
<div class="col-sm-3">
...
<div class="checkbox checkbox-inline">
<input type="checkbox" id="inlineCheckbox7" name="passengerairbag" checked value="1">
<label for="inlineCheckbox7"> Passenger Airbag </label>
</div>
<?php } else { ?>
<div class="checkbox checkbox-inline">
<input type="checkbox" id="inlineCheckbox7" name="passengerairbag" value="1">
<label for="inlineCheckbox7"> Passenger Airbag </label>
</div>
<?php } ?>
</div>
...
<div class="checkbox checkbox-inline">
<input type="checkbox" id="inlineCheckbox8" name="powerwindow" checked value="1">
<label for="inlineCheckbox8"> Power Windows </label>
</div>
<?php } else { ?>
<div class="checkbox checkbox-inline">
<input type="checkbox" id="inlineCheckbox8" name="powerwindow" value="1">
<label for="inlineCheckbox8"> Power Windows </label>
</div>
<?php } ?>
</div>
...
<div class="checkbox checkbox-inline">
<input type="checkbox" id="inlineCheckbox9" name="cdplayer" checked value="1">
<label for="inlineCheckbox9"> CD Player </label>
</div>
<?php } else {?>
<div class="checkbox checkbox-inline">
<input type="checkbox" id="inlineCheckbox9" name="cdplayer" value="1">
<label for="inlineCheckbox9"> CD Player </label>
</div>
<?php } ?>
</div>
...
<div class="checkbox checkbox-inline">
<input type="checkbox" id="inlineCheckbox10" name="centrallocking" checked value="1">
<label for="inlineCheckbox10">Central Locking</label>
</div>
<?php } else { ?>
<div class="checkbox checkbox-success checkbox-inline">
<input type="checkbox" id="inlineCheckbox10" name="centrallocking" value="1">
<label for="inlineCheckbox10">Central Locking</label>
</div>
<?php } ?>
</div>
...
<div class="checkbox checkbox-inline">
<input type="checkbox" id="inlineCheckbox11" name="crashcensor" checked value="1">
<label for="inlineCheckbox11"> Crash Sensor </label>
</div>
<?php } else {?>
<div class="checkbox checkbox-inline">
<input type="checkbox" id="inlineCheckbox11" name="crashcensor" value="1">
<label for="inlineCheckbox11"> Crash Sensor </label>
</div>
<?php } ?>
</div>
...
<div class="checkbox checkbox-inline">
<input type="checkbox" id="inlineCheckbox12" name="leatherseats" checked value="1">
<label for="inlineCheckbox12"> Leather Seats </label>
</div>
<?php } else { ?>
<div class="checkbox checkbox-inline">
<input type="checkbox" id="inlineCheckbox12" name="leatherseats" value="1">
<label for="inlineCheckbox12"> Leather Seats </label>
</div>
<?php } ?>
</div>
